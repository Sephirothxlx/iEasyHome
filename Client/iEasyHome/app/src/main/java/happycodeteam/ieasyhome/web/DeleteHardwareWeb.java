...
public class DeleteHardwareWeb {

    private static String IP = IPWeb.IP;

    // 通过Get方式获取HTTP服务器数据
    public static ArrayList<HashMap> deleteHardware(String hardware_id,String username) {
        ...
        try {
            // 用户名 密码
            // URL 地址
            String path = "http://" + IP + "/iEasyHome/DeleteHardware" ;
            path = path + "?hardware_id=" + hardware_id +"&username="+username;
